...
<div class="bg-zinc-900/50 border border-zinc-700 rounded-2xl shadow-xl backdrop-blur-sm overflow-hidden">
    <div class="p-6 border-b border-zinc-800 flex justify-between items-center">
        ...
        <a href="{{ route('clientes-crear') }}" class="bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold py-2 px-4 rounded-lg transition-all shadow-lg shadow-sky-500/20 uppercase">
            + Nuevo cliente
        </a>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-zinc-800/50">
                    ...
                    <th class="px-6 py-4 text-zinc-400 text-xs font-bold uppercase tracking-wider text-center">Dominios</th>
                ...
                <tr class="hover:bg-zinc-800/30 transition-colors group">
                    <td class="px-6 py-4">
                        <div class="flex items-center">
                            <div class="h-10 w-10 rounded-full bg-zinc-800 border border-zinc-700 flex items-center justify-center text-sky-500 font-bold mr-3 shadow-inner">
                    ...
                    <td class="px-6 py-4">
                        <span class="text-sm text-zinc-300 font-mono bg-zinc-800/50 px-2 py-1 rounded border border-zinc-700/50">
                            {{ $cliente->username ?? '---' }}
                        </span>
                    </td>
                    <td class="px-6 py-4 text-center">
                        <span class="px-3 py-1 rounded-full text-xs font-bold {{ $cliente->dominios_count > 0 ? 'bg-sky-500/10 text-sky-400 border border-sky-500/20' : 'bg-zinc-800 text-zinc-500 border border-zinc-700' }}">
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        ...
                        <button class="p-2 text-zinc-400 hover:text-sky-400 transition-colors" title="Editar">
                            <svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 pull-right 2 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                        </button>
                    </td>
                </tr>
                @empty
